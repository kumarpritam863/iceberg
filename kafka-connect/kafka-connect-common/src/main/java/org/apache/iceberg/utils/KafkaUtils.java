...
public class KafkaUtils {
  ...
  public static ConsumerGroupDescription consumerGroupDescription(String consumerGroupId, Admin admin) {
    try {
  ...
  public static ConsumerGroupMetadata consumerGroupMetadata(SinkTaskContext context) {
    return kafkaConsumer(context).groupMetadata();
  }

  public static void seekToLastCommittedOffsets(SinkTaskContext context) {
